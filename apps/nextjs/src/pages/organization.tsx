...
const organization: NextPage = () => {
  ...
  // Update
  const { mutate: updateorganization } = trpc.organization.updateOrganization.useMutation(
    {},
  );
  // Delete
  const { mutate: deleteEmplayee } = trpc.organization.deleteOrganization.useMutation(
    {},
  );
                ...
                {data?.map((organization) => {
                  return (
                    <div key={organization.id}>
                      ...
                      <button onClick={() => btnDeleteorganization(organization.id)}>
                        Delete
                      </button>
                    </div>
                  );
